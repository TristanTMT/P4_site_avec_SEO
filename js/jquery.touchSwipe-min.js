! function(a) { "function" == typeof define && define.amd && define.amd.jQuery ? define(["jquery"], a) : a("undefined" != typeof module && module.exports ? require("jquery") : jQuery) }(function(f) {
    ...
    function D(a5, at) {
        ...
        function L(bc) { var bd = bc.originalEvent ? bc.originalEvent : bc,
                be = bd.touches; if (be) { if (be.length && !ak()) { return F(bd), !0 } if (be.length && ak()) { return !0 } } return ak() && (W = ax), a3 = aq(), ab = aM(), bb() || !al() ? (Z = q, O(bd, Z)) : at.triggerOnTouchEnd || at.triggerOnTouchEnd === !1 && Z === k ? (at.preventDefaultEvents !== !1 && bc.cancelable !== !1 && bc.preventDefault(), Z = h, O(bd, Z)) : !at.triggerOnTouchEnd && a7() ? (Z = h, aD(bd, Z, A)) : Z === k && (Z = q, O(bd, Z)), am(!1), null }
        ...
        function ad() { return null === at.pinchThreshold || ao >= at.pinchThreshold }

        function az() { var bc; return bc = !at.maxTimeThreshold || !(ab >= at.maxTimeThreshold) }
        ...
        function a0() { return ab > at.longTapThreshold && af < r }
        ...
        function aS(bc) { if (M[bc]) { return M[bc].distance } }
        ...
        function aF(bf, bd) { var bc = bf.x - bd.x,
                bh = bd.y - bf.y,
                be = Math.atan2(bh, bc),
                bg = Math.round(180 * be / Math.PI); return bg < 0 && (bg = 360 - Math.abs(bg)), bg }

        function aL(bd, bc) { if (aT(bd, bc)) { return m } var be = aF(bd, bc); return be <= 45 && be >= 0 ? p : be <= 360 && be >= 315 ? p : be >= 135 && be <= 225 ? o : be > 45 && be < 135 ? x : e }
